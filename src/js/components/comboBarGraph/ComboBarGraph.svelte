<script>
  import LineGraphAxes from 'components/lineGraph/LineGraphAxes.svelte';
  import LineGraphLabels from 'components/lineGraph/LineGraphLabels.svelte';
  import ComboBars from './ComboBars.svelte';
...
<div
  ...
  on:touchstart|stopPropagation|preventDefault={onPointerDown}>
    <svg
      ...
      class:txcm-lineGraph-is-compact={false}
      width="100%"
      height={height}>
        <LineGraphAxes
          {padding} />    
